# Weng Teaches JSON Web Token (JWT) on React/Express

![Last Commit](https://img.shields.io/github/last-commit/Siphon880gh/weng-teaches-react-express-jwt-json-web-token/main)
...
---
By Weng Fei Fung. This is a lesson made to help students. Learn how to keep users logged in with JSON Web Tokens on React-Express stack using jwt-decode and jsonwebtoken. Learn the common uses.